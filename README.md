> [!NOTE]
> **한국어 · OpenCodex 배포판 2.0.9** — 공식 v2.0.8 (`067c40dc64f3f108496aa9adf289f1e8c264fe9c`)을 기준으로 사용자 UI를 한국어화하고,
> 공식 사용자 지정 공급자에 OpenCodex 프리셋을 추가했습니다. 응답 완료 확인, 요약 전송 상태와 브라우저 복구의 반복·멈춤 문제도 수정했습니다.
> 복구 수정은 Windows·macOS 공통 소스와 확장에 적용됩니다. 한국어판 2.0.9는 공식 2.0.9라는 뜻이 아니라 이 배포판의 개정 번호입니다. 기존 2.0.8 릴리스는 덮어쓰지 않습니다.
